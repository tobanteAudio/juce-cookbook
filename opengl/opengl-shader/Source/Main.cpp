...
//==============================================================================
class OpenGLShaderApplication : public JUCEApplication
{
public:
    //==============================================================================
    OpenGLShaderApplication() {}
    ...
    */
    ...
    public:
        MainWindow(String name)
            : DocumentWindow("tobanteAudio: OpenGL - Shader",
...
START_JUCE_APPLICATION(OpenGLShaderApplication)
